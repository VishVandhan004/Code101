...
// import java.util.*;
// class   Solution {
//     public static int check(int[] arr,Map<Integer,Integer> m,int idx){
//         if(idx>=arr.length) return 0;
//         if(m.containsKey(idx)) return m.get(idx);
//         int p = arr[idx]+check(arr,m,idx+2);
//         int np = check(arr,m,idx+1);
//         int max = Math.max(p,np);
//         m.put(idx,max);
//         return max;
//     }
//     public static void main (String[] args) {
...
//         System.out.println(check(arr,m,0));
//     }
// }
